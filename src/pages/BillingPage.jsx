        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-16">
            <div className="space-y-6">
                <div className="space-y-4">
                    <h2 className="text-xl text-[#DB4444] font-medium">Your Address</h2>
                    <AddressBookCard handleClick={handleClick} path="billing"/>
                </div>
                <div className="space-y-4">
                    <h2 className="text-xl text-[#DB4444] font-medium">Your Shipping</h2>
                    <ShippingCard />
                </div>
                <div className="space-y-4">
                    <h2 className="text-xl text-[#DB4444] font-medium">Your Note</h2>
                    <input type="text" className="w-full border border-black rounded p-2" placeholder="Message for Sellers"/>
                </div>
            </div>
